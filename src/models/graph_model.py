...
class GraphModel(nn.Module):
    def __init__(self, base_model, d_feat, hidden_size, num_layers, dropout, use_residual, is_homogeneous):
        super().__init__()
        if base_model == "GRU":
            self.rnn = nn.GRU(
                input_size=d_feat,
...
#     def __init__(self, base_model, d_feat, hidden_size, num_layers, dropout, use_residual):
#         super().__init__()
#         if base_model == "GRU":
#             self.rnn = nn.GRU(
#                 input_size=d_feat,
